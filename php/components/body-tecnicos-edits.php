  ...
  <div class="row mt-2">
          ...
          <div class="px-5 py-4">
            ...
            <div class="mb-3 d-flex gap-2">
              <div class="col">
                ...
                <input type="text" class="form-control form-control-sm nombreTecnico" id="exampleInputEmail1"
                  aria-describedby="emailHelp">
              </div>
              <div class="col">
                <label for="exampleInputEmail1" class="form-label">Apellido</label>
                <input type="text" class="form-control form-control-sm apellidoTecnico" id="exampleInputEmail1"
                  aria-describedby="emailHelp">
              </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 d-flex gap-2">
              <div class="col">
                ...
                <select class="form-select form-select-sm cmbEspecializacionTecnico combo-area-e"
            ...
            <div class="mb-3 row">
              <div class="col-6">
                ...
                <input type="date" class="form-control form-control-sm contratacionTecnico" id="exampleInputEmail1"
                  aria-describedby="emailHelp">
              </div>
              <div class="col-6">
                <label for="exampleInputEmail1" class="form-label">Nacio:</label>
                <input type="date" class="form-control form-control-sm nacimientoTecnico" id="exampleInputEmail1"
                  aria-describedby="emailHelp2">
              </div>
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Salario</label>
              <input type="number" class="form-control form-control-sm salarioTecnico" id="exampleInputEmail1"
                aria-describedby="emailHelp">
            </div>
    ...
    <div class="col-8 p-2">
      ...
      <div class="mt-3 container header bg-white rounded p-4 shadow-sm" style="height:40.5vh">
        ...
        <hr>
        <div class="w-100 bg-light d-flex gap-2 p-3 rey rounded overflow-x-auto serviciosSee" style="height: 28vh">
      ...
      <div class="modal-body">
        <div class="mb-3 row">
          <div class="col">
            ...
            <input type="date" class="form-control form-control-sm fechaVisita" id="exampleInputEmail1"
              aria-describedby="emailHelp">
          </div>
          <div class="col">
            <label for="exampleInputEmail1" class="form-label">Horas a visitar</label>
            <input type="number" class="form-control form-control-sm horasVisita" id="exampleInputEmail1"
              aria-describedby="emailHelp">
          </div>
        </div>
        <div class="mb-3">
